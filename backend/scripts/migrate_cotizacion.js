// Migración HU-FAC-08: Cotización vinculada a productos e impuestos
...
async function migrate() {
  try {
    ...
    // Índices
    await sequelize.query(`CREATE INDEX IF NOT EXISTS idx_cotizacion_cliente ON cotizacion(cod_cliente);`);
    await sequelize.query(`CREATE INDEX IF NOT EXISTS idx_cotizacion_estado ON cotizacion(estado_cotizacion);`);
    await sequelize.query(`CREATE INDEX IF NOT EXISTS idx_detalle_cotizacion_cot ON detalle_cotizacion(cod_cotizacion);`);
