import * as productoService from '../services/producto.service.js'; // // Service de producto
...
export const createProducto = async (req, res, next) => {
  try {
    // // req.body debe traer los campos de producto:
    // // cod_categoria, nombre_producto, unidad_medida, precio_venta, isv, estado_producto
